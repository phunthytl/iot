...
export default function Dashboard2() {
    ...
    // === LẤY AQI TỪ API (KHÔNG RANDOM NỮA) ===
    useEffect(() => {
        const interval = setInterval(async () => {
            try {
                ...
                // Chỉ hiển thị warning, không gửi lệnh
    ...
    return (
        ...
        <div className="dashboard-container">
            ...
            <h2>
                <FaCloud color="#00b4d8" /> Biểu đồ chất lượng không khí
            </h2>
